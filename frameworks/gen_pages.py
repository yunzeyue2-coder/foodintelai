...
<div class="field"><div class="fl">APPLIED RESEARCH · 应用研究</div>
<div class="rel-tags">
<a href="../research/早餐系列_价格带锁死商业模式.html" class="rt">早餐价格带模型</a>
<a href="../research/早餐系列_包子为什么不是蜜雪.html" class="rt">包子vs蜜雪冰城</a>
<a href="../research/早餐系列_老板隐形成本.html" class="rt">老板自由度模型</a>
<a href="../research/早餐系列_中国早餐没有霸主.html" class="rt">中国早餐九大门派</a>
</div></div>
<div class="field"><div class="fl">FRAMEWORK METADATA · 资产登记</div>
<div class="fb" style="font-size:12px;color:#888">
<table style="width:100%;border-collapse:collapse;font-size:12px;margin-top:6px">
<tr><td style="padding:4px 10px;border:1px solid #eee;color:#888;width:100px">Asset ID</td><td style="padding:4px 10px;border:1px solid #eee;color:#2a2218;font-weight:600">{code}</td>
<td style="padding:4px 10px;border:1px solid #eee;color:#888;width:70px">Version</td><td style="padding:4px 10px;border:1px solid #eee;color:#2a2218">{version}</td>
<td style="padding:4px 10px;border:1px solid #eee;color:#888;width:70px">Status</td><td style="padding:4px 10px;border:1px solid #eee;color:#2a5a3a">{evidence}</td></tr>
<tr><td style="padding:4px 10px;border:1px solid #eee;color:#888">Category</td><td style="padding:4px 10px;border:1px solid #eee;color:#2a2218">{category}</td>
<td style="padding:4px 10px;border:1px solid #eee;color:#888">Updated</td><td style="padding:4px 10px;border:1px solid #eee;color:#2a2218">2026.07.23</td>
<td style="padding:4px 10px;border:1px solid #eee;color:#888">Visibility</td><td style="padding:4px 10px;border:1px solid #eee;color:#2a2218">Public</td></tr>
</table>
</div></div>
<hr>
