#!/usr/bin/env python3
"""批量生成饮料V4产品卡 YL-004 ~ YL-030 (共27款)"""
...
CARDS = [
    ("004", "草莓小丸子", "冷饮700ml · 草莓糯米丸子生椰",
     ["低投资","夜市","甜品饮品","Q弹"],
     "🔥 热销推荐", "摆摊指数 7/10", "复购指数 8/10",
     "糯米丸子是这杯的点睛之笔。有次在学校门口试摊，<em>一个女生喝了一口就说"丸子好好吃"</em>，又回头买了两杯。草莓浆80ml配生椰乳120ml，椰香和莓香混在一起，底下还有水晶冻。成本6.29，卖14-16。<br><br>关键是糯米丸子要现煮，放久了会硬，出餐节奏要卡好。",
     "约¥6.29", "¥14-16/杯", "50-80杯", "≈¥700-1280", "≈¥315-503", "~¥50-100", "≈¥335-677",
     "15-22天", "10-15天", "5-10天",
     (4,2,1,2),
     ["糯米小丸子","水晶冻","草莓浆","茉莉绿茶茶汤","冰糖糖浆","蜜制草莓","生椰乳","雪克杯"],
     ["夜市","学校周边","步行街","饮品摊","公园"],
     "某co草莓小丸子¥16 vs 摆摊¥14-16/杯", "价格差不多但摆摊用料更扎实，丸子更多，草莓味更浓。",
     "「杯底有糯糯的小丸子，嚼着嚼着就喝完一杯。」",
    ...
    ("006", "生椰可可冰茶", "冷饮500ml · 巧克力生椰冰沙",
     ["低投资","创意饮品","甜品","夏日"],
     "⭐ 特色推荐", "摆摊指数 6/10", "复购指数 7/10",
     "这杯是我们从广禧夏季菜单挖来的创意款。<em>杯壁抹巧克力酱，生椰乳打底，可可冰沙顶上，再插一根雪糕</em>——一杯顶三样。成本12.7，卖18-22。适合摆在甜品摊或者炸鸡摊旁边做搭配。<br><br>雪糕成本占大头，可以找批发商拿整箱的，单支能压到3块左右。",
     "约¥12.7", "¥18-22/杯", "40-60杯", "≈¥720-1320", "≈¥508-762", "~¥50-100", "≈¥162-458",
     "20-30天", "15-20天", "8-12天",
     (3,3,1,2),
     ["巧克力酱","生椰乳","可可粉","冰糖糖浆","喷射奶油","雪糕","冰沙机","成品杯"],
     ["夜市","商场周边","游乐场","甜品摊"],
     "同类创意饮品店¥28-35 vs 摆摊¥18-22/杯", "雪糕成本高，但整杯视觉冲击强，适合发朋友圈拍照打卡。",
     "「巧克力+生椰+雪糕，一杯下去三个满足。」",
